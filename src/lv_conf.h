...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE  "mainloop.hpp"       /*Header for the sys time function*/
#define LV_TICK_CUSTOM_SYS_TIME_EXPR ((uint32_t)_p44_millis())     /*Expression evaluating to current systime in ms*/
